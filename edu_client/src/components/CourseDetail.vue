        ...
        <div class="main">
            <div class="course-info">
                ...
                <div class="wrap-right">
                    ...
                    <div class="buy">
                        ...
                        <div class="add-cart" @click="addCard"><img src="/static/image/cart-yellow.svg" alt="">加入购物车
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="course-tab">
                <ul class="tab-list">
                    ...
                    <li :class="tabIndex==3?'active':''" @click="tabIndex=3">用户评论 ({{wen_list.length}})</li>
            ...
            <div class="course-content">
                <div class="course-tab-list">
                    ...
                    <div class="tab-item" v-if="tabIndex==3">
                        用户评论 <br>
                        <input type="text" v-model="wen" style="width:200px;">
                        <button @click="addtext">发表</button>
                        <ul>
                            <li v-for="(wen,index) in this.wen_list">第{{index+1}}条:&nbsp;&nbsp;&nbsp;&nbsp;{{wen}}</li>
                        </ul>
                    </div>
        ...
        methods: {
            ...
            addCard() {
                ...
                this.$axios.post('http://127.0.0.1:9001/cart/option/', {
                    ...
                    //向状态机提交动作来修改商品的总数
                    this.$store.commit('add_cart', res.data.course_length)
            ...
            //获取当前课程的详细信息
            get_course_detail() {
                //获取上个页面传递过来的id:this.$route.params.id
                this.$axios({
                    url: 'http://127.0.0.1:9001/course/detail/' + this.course_id + '/',
                    method: 'get',
                }).then(res => {
            ...
            //获取章节以及章节对应的课时信息
            get_course_chapter() {
                this.$axios.get('http://127.0.0.1:9001/course/chapter/', {
                    params: {
