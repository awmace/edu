...
<script>
    ...
    export default {
        ...
        methods: {
            //获取所有课程分类(CourseCategory)的信息,axios请求
            get_all_category() {
                this.$axios.get('http://127.0.0.1:9001/course/category/').then(res => {
                    //成功执行如下内容
            ...
            get_all_course() {
                ...
                this.$axios.get('http://127.0.0.1:9001/course/list_filter/', {
                    params: filters
                }).then(response => {
