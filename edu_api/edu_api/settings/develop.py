...
SECRET_KEY = '6g@1(x)w#(c18l8k)t_uozwbgzs*!)a((!oyncbu_1bbauq(ol'
...
LOGGING = {
    ...
    # 日志对象，与django集成使用:去掉file控制台不再打印
    'loggers': {
        'django': {
...
CACHES = {
    ...
    "npf": {
        "BACKEND": "django_redis.cache.RedisCache",
        # 连接的redis所在服务的端口以及ip
        "LOCATION": "redis://127.0.0.1:7000/10",
        # 使用客户端的方式
        "OPTIONS": {
            "CLIENT_CLASS": "django_redis.client.DefaultClient",
        }
...
ALIAPY_CONFIG = {
    ...
    "appid": "2016102500761005",
    "app_notify_url": None,
    "app_private_key_path": open(os.path.join(BASE_DIR, "apps/payments/keys/app_private_key.pem")).read(),
    "alipay_public_key_path": open(os.path.join(BASE_DIR, "apps/payments/keys/app_public_key.pem")).read(),
    "sign_type": "RSA2",
    "debug": False,
